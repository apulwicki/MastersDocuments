...
A finer resolution DEM could also result in higher LR explanatory power. SWE is highly variable within a grid cell and certain topographic parameters, such a wind redistribution and curvature, can change at scales less than a grid cell so improved resolution could allow correlations to be more prevalent.
