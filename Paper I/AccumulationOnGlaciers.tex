...
%%% 
%Add this citation to the discussion \citep{Musselman2015}
%Compared with measurements,distributed snow model depth and water equivalent errors were smallest using either of the two turbulence models, with the best representation of downwind drifts by the computational fluid dynamics model.
% Uncertainty can be reduced by using physically based wind flow models to drive distributed snow models
%Sublimation was an important mass loss from the ridge, and wind flow model choice resulted in cumulative seasonal sublimation differences ranging from 10.5% to 19.0% of seasonal snowfall.-> submlimation parameter? Wind effects sublimation as well as redictibutoin of snow
