...
Winter surface mass balance is the net accumulation and ablation assuming no internal snow pack accumulation over the winter season \citep{Cogley2011}, and constitutes the addition of glacier mass when considering the net mass balance. We refer to this quantity as winter balance throughout the paper. Accurate estimates of winter balance are critical for glacier mass balance estimates, not only because winter balance constitutes half of the glacier mass balance but also because the distribution of snow on a glacier initializes the summer balance and high snow albedo contributes to reduced summer melt \citep{Hock2005, Reveillet2016}. 
...
By investigating tools and methodologies applied in snow science literature, we hope to identify ways to improve snow survey design and estimates of SWE.

winter balance in mass balance studies
winter balance studies specifically
snow science is sophisticated
draw on snow science to improve winter balance
