...
\abstract{Accurately estimating winter surface mass balance on glaciers is central to quantifying overall mass balance and melt runoff. However, measuring and modelling snow distribution and variability is inherently difficult in alpine terrain, resulting in high winter balance uncertainty. The goals of this paper are to examine methods and sources of error when converting snow measurements to estimates of winter balance and to gain a more comprehensive understanding of uncertainties inherent in this process. We extensively measure snow depth and density, at various spatial scales, on three glaciers in the St. Elias Mountains, Yukon. Elevation is found to be the dominant driver of accumulation variability but the relationship varies between glaciers. Wind redistribution and preferential deposition are also shown to affect snow distribution, but more complex parametrization is needed to fully capture wind effects. Through Monte Carlo analysis we find that interpolation of SWE measurements is the largest source of winter balance uncertainty. Snow distribution patterns differ considerably between glaciers, highlighting strong inter- and intra-basin variability. Despite the challenges associated with accurately and precisely estimating winter balance, our results are consistent with the previously reported regional accumulation gradient. }
...
Winter balance is notoriously difficult to estimate. Snow distribution in alpine regions is highly variable and influenced by dynamic interactions between the atmosphere and complex topography, operating on multiple spatial and temporal scales \citep[e.g.][]{Barry1992, Liston2006, Clark2011}. Extensive, high resolution and accurate snow distribution measurements on glaciers are almost impossible to achieve due to limitations of the various methods used to quantify snow water equivalent \citep[e.g.][]{Cogley2011, McGrath2015}. For example, snow probes yield accurate point measurements but have negligible spatial coverage. Conversely, gravimetric methods yield spatially extensive measurements of mass change but cannot capture spatial variability of snow within a basin \citep{Cogley2011}. 

Most glacier mass balance programs that employ direct measurements estimate winter balance in a similar way to summer balance, where snow depth measurements taken at a few stake locations are interpolated using basic methods \citep[e.g.][]{Hock1999, Thibert2008, MacDougall2011, Cullen2017}. However, this equivalence is likely inappropriate. Melt is strongly affected by air temperature and solar radiation \citep[e.g.][]{Hock2005}, both of which are consistent across large spatial domains \citep[e.g.][]{Barry1992}. Conversely, snow distribution is largely driven by precipitation \citep[e.g.][]{Lehning2008} and wind patterns \citep[e.g.][]{Bernhardt2009, Musselman2015}, which are known to be highly heterogeneous in alpine environments \citep[e.g.][]{Barry1992}. Snow distribution is therefore highly variable and has short correlation length scales \citep[e.g.][]{Anderton2004, Egli2011, Grunewald2010, Helbig2017, Lopez2011, Lopez2013, Machguth2006, Marshall2006}, contributing to a high level of uncertainty in mass balance models that few studies have directly addressed. 
...
\textbf{} & \textbf{Location} & \multicolumn{3}{c}{\textbf{Elevation (m a.s.l)}} & \textbf{Slope ($^{\circ}$)} & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Area\\ (km)\end{tabular}}} & \multirow{2}{*}{\textbf{Date}} & \multicolumn{4}{c}{\textbf{Survey Details}} \\
 & UTM Zone 7 & \textit{Mean} & \textit{Range} & \textit{ELA} & \textit{Mean} &  &  & $n_{\mathrm{T}}$ & $d_{\mathrm{T}}$ (km) & $n_{\rho}$ & $n_{\mathrm{zz}}$ \\ \hline
\textbf{G4} & \begin{tabular}[c]{@{}c@{}}595470 E\\ 6740730 N\end{tabular} & 2344 & 1958--2809 &  & 12.8 & 3.8 & 4--7 May 2016 & 649 & 13.1 & 7 & 3 \\
\textbf{G2} & \begin{tabular}[c]{@{}c@{}}601160 E\\ 6753785 N\end{tabular} & 2495 & 1899--3103 &  & 13.0 & 7.0 & 8--11 May 2016 & 762 & 13.6 & 7 & 3 \\
\textbf{G13} & \begin{tabular}[c]{@{}c@{}}604602 E\\ 6763400 N\end{tabular} & 2428 & 1923--3067 &  & 13.4 & 12.6 & 12--15 May 2016 & 941 & 18.1 & 19 & 4
\end{tabular}
\end{table*}
