...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure*}
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_centreline.png}
            \caption[]{}    
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_trans.png}
             \caption[]{}    
        \end{subfigure}
        \vskip\baselineskip
 \begin{subfigure}[b]{0.475\textwidth}
            \centering
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_circle.png}
            \caption[]{}    
        \end{subfigure}
        \hfill
        \begin{subfigure}[b]{0.475\textwidth}  
            \centering 
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_hourglass.png}
             \caption[]{}    
        \end{subfigure}
        \vskip\baselineskip
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_hourCircle.png}
             \caption[]{}    
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.475\textwidth}   
            \centering 
            \includegraphics[width=\textwidth]{/Users/Alexandra/Documents/SFU/Data/Plots/SampleDesign_random.png}
            \caption[]{}    
        \end{subfigure}
        \caption{Synthetic sampling designs on three study glacier. (a) Midline. (b) Midline and transverse. (c) Circle. (d) Hourglass. (e) Hourglass and circle. (f) Random across entire glacier. All synthetic observation measurement locations (small, black dots) and a subset including 20 measurement locations (open circles) is shown for each sampling pattern. Sampling designs are overlain on the prescribed winter balance (WB). } 
