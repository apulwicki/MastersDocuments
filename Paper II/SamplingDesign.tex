...
\label{my-label}
\begin{tabular}{ccccccc}
 & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} & \textbf{5} & \textbf{6} \\ \midrule \midrule
\textbf{Glacier 4} & \begin{tabular}[c]{@{}c@{}}\textcolor{C}{C} (8)\\ \textcolor{H}{H} (8)\end{tabular} &  & \begin{tabular}[c]{@{}c@{}}\textcolor{MT}{MT} (9)\\ \textcolor{HC}{HC} (9)\end{tabular} &  & \textcolor{R}{R} (10) & \textcolor{M}{M} (14) \\ \midrule
\textbf{Glacier 2} & \begin{tabular}[c]{@{}c@{}}\textcolor{C}{C} (10)\\ \textcolor{H}{H} (10)\end{tabular} &  & \begin{tabular}[c]{@{}c@{}}\textcolor{MT}{MT} (11)\\ \textcolor{HC}{HC} (11)\end{tabular} &  & \textcolor{R}{R} (12) & \textcolor{M}{M} (43) \\ \midrule
\textbf{Glacier 13} & \textcolor{MT}{MT} (9) & \textcolor{HC}{HC} (11) & \begin{tabular}[c]{@{}c@{}}\textcolor{C}{C} (12)\\ \textcolor{H}{H} (12)\end{tabular} &  & \textcolor{R}{R} (13) & \textcolor{M}{M} (101) \\ \midrule \midrule
\textbf{Glacier 4} & \begin{tabular}[c]{@{}c@{}}\textcolor{C}{C} (8)\\ \textcolor{H}{H} (8)\end{tabular} &  & \textcolor{HC}{HC} (9) & \textcolor{R}{R} (10) & \textcolor{MT}{MT} (13) & \textcolor{M}{M} (--) \\ \midrule
\textbf{Glacier 2} & \textcolor{MT}{MT} (21) & \textcolor{H}{H} (26) & \begin{tabular}[c]{@{}c@{}}\textcolor{HC}{HC} (29)\\ \textcolor{R}{R} (29)\end{tabular} &  & \textcolor{C}{C} (47) & \textcolor{M}{M} (--) \\ \midrule
\textbf{Glacier 13} & \textcolor{MT}{MT} (34) & \textcolor{H}{H} (44) & \textcolor{R}{R} (49) & \textcolor{HC}{HC} (50) & \textcolor{C}{C} (96) & \textcolor{M}{M} (--) \\ \midrule \midrule
